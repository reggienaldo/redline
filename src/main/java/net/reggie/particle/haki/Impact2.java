...
public class Impact2 extends SpriteBillboardParticle {

    private final SpriteProvider spriteProvider;

    Impact2(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientWorld world,
            ...
            return new Impact2(world, x, y, z, vx, this.spriteProvider);
        }
    }
}